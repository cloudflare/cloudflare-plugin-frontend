...
export const ZONE_ENTITLEMENTS = 'ZONES_ENTITLEMENTS';
export const ZONE_ENTITLEMENTS_SUCCESS = 'ZONES_ENTITLEMENTS_SUCCESS';
export const ZONE_ENTITLEMENTS_ERROR = 'ZONES_ENTITLEMENTS_ERROR';
