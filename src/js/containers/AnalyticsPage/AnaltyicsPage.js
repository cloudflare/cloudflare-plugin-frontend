  ...
  getRequestsColumns(analytics) {
    ...
    if(analytics && analytics.timeSeries && analytics.requests) {
      columns =[
        ...
        {
          label: this.props.intl.formatMessage({ id: 'containers.analyticsPage.cached' }),
          values: analytics.requests[0]
        },
        {
          label: this.props.intl.formatMessage({ id: 'containers.analyticsPage.uncached' }),
  ...
  getUniquesColumns(analytics) {
    ...
    if(analytics && analytics.timeSeries && analytics.uniques) {
      columns =[
        ...
        {
          label: this.props.intl.formatMessage({ id: 'containers.analyticsPage.uniques' }),
  ...
  getThreatsColumns(analytics) {
    ...
    if(analytics && analytics.timeSeries && analytics.threats) {
      columns =[
        ...
        {
          label: this.props.intl.formatMessage({ id: 'containers.analyticsPage.threats' }),
        ...
        <div>
          ...
          <Tabs
            ...
            <TabsPanel id={ REQUESTS_TAB }>
              <LayoutContainer>
                ...
                <LayoutRow>
                  <TimeSeriesChart xAxisValues={ this.getRequestsColumns(analytics) } yAxisLabel={ formatMessage({ id: 'container.analyticsPage.tabs.requests' }) }/>
                </LayoutRow>
              </LayoutContainer>
            </TabsPanel>
              ...
              <LayoutContainer>
                ...
                <LayoutRow>
                  <LayoutColumn width={1/3}>
                    ...
                    { analytics.totals ? humanFileSize(analytics.totals.bandwidth.all) : "" }
                  </LayoutColumn>
                  <LayoutColumn width={1/3}>
                    <h5>{formatMessage({ id: 'container.analyticsPage.tabs.bandwidth.cached' }) }</h5>
                    { analytics.totals ? humanFileSize(analytics.totals.bandwidth.cached) : "" }
                  </LayoutColumn>
                  <LayoutColumn width={1/3}>
                    <h5>{formatMessage({ id: 'container.analyticsPage.tabs.bandwidth.uncached' }) }</h5>
                    { analytics.totals ? humanFileSize(analytics.totals.bandwidth.uncached) : "" }
                  </LayoutColumn>
                </LayoutRow>
                <LayoutRow>
                  <TimeSeriesChart xAxisValues={ this.getBandwidthColumns(analytics) }  yAxisLabel={ formatMessage({ id: 'container.analyticsPage.tabs.bandwidth' }) }/>
                </LayoutRow>
              </LayoutContainer>
            </TabsPanel>
            ...
            <TabsPanel id={ UNIQUES_TAB }>
              <LayoutContainer>
                ...
                <LayoutRow>
                  <TimeSeriesChart xAxisValues={ this.getUniquesColumns(analytics) } yAxisLabel={ formatMessage({ id: 'container.analyticsPage.tabs.uniques' }) }/>
                </LayoutRow>
              </LayoutContainer>
            </TabsPanel>
            ...
            <TabsPanel id={ THREATS_TAB }>
              <LayoutContainer>
                ...
                <LayoutRow>
                  <TimeSeriesChart xAxisValues={ this.getThreatsColumns(analytics) } yAxisLabels={ formatMessage({ id: 'container.analyticsPage.tabs.threats' }) }/>
                </LayoutRow>
              </LayoutContainer>
            </TabsPanel>
          </Tabs>
          ...
          <LayoutRow>
            <LayoutColumn width={74/150}>
              <AnalyticCard title={ formatMessage({ id: 'container.analyticCard.ssl.title' }) } description={ formatMessage({ id: 'container.analyticCard.duration' }) } data={ analytics.totals ? analytics.totals.requests.ssl : 0 } dataType={ formatMessage({ id: 'container.analyticCard.ssl.datatype' }) } />
            </LayoutColumn>
            <LayoutColumn width={2/150}>&nbsp;</LayoutColumn>
            <LayoutColumn width={74/150}>
              <AnalyticCard title={ formatMessage({ id: 'container.analyticCard.bandwidth.title' }) } description={ formatMessage({ id: 'container.analyticCard.duration' }) } data={ analytics.totals ? analytics.totals.bandwidth : 0 } dataType={ formatMessage({ id: 'container.analyticCard.bandwidth.datatype' }) } />
            </LayoutColumn>
          </LayoutRow>
