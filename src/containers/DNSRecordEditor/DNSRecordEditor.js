      ...
      <div>
        <Table>
          <TableHead>
            <TableRow>
              <TableHeadCell>
                <FormattedMessage id="container.dnsRecordEditor.thead.type" />
              </TableHeadCell>
              <TableHeadCell>
                <FormattedMessage id="container.dnsRecordEditor.thead.name" />
              </TableHeadCell>
              <TableHeadCell>
                <FormattedMessage id="container.dnsRecordEditor.thead.value" />
              </TableHeadCell>
              <TableHeadCell>
                <FormattedMessage id="container.dnsRecordEditor.thead.ttl" />
              </TableHeadCell>
              <TableHeadCell>
                <FormattedMessage id="container.dnsRecordEditor.thead.status" />
              </TableHeadCell>
            </TableRow>
          </TableHead>
          <TableBody>
