...
import ApplyDefaultSettingsCard
  from "../containers/ApplyDefaultSettingsCard/ApplyDefaultSettingsCard";
import BrowserCacheTTLCard
  from "../containers/BrowserCacheTTLCard/BrowserCacheTTLCard";
import BrowserIntegrityCheckCard
  from "../containers/BrowserIntegrityCheckCard/BrowserIntegrityCheckCard";
import CacheLevelCard from "../containers/CacheLevelCard/CacheLevelCard";
import ChallengePassageCard
  from "../containers/ChallengePassageCard/ChallengePassageCard";
import DevelopmentModeCard
  from "../containers/DevelopmentModeCard/DevelopmentModeCard";
import IPV6Card from "../containers/IPV6Card/IPV6Card";
import ImageOptimizationCard
  from "../containers/ImageOptimizationCard/ImageOptimizationCard";
...
import SecurityLevelCard
  from "../containers/SecurityLevelCard/SecurityLevelCard";
import WAFCard from "../containers/WAFCard/WAFCard";
import PluginSpecificCacheCard
  from "../containers/PluginSpecificCacheCard/PluginSpecificCacheCard";
import PluginSpecificCacheTagCard
  from "../containers/PluginSpecificCacheTagCard/PluginSpecificCachetTagCard.js";
import RailgunCard from "../containers/RailgunCard/RailgunCard";
import AutomaticHTTPSRewritesCard
  from "../containers/AutomaticHTTPSRewritesCard/AutomaticHTTPSRewritesCard";
import BypassCacheByCookieCard
  from "../containers/BypassCacheByCookieCard/BypassCacheByCookieCard";
