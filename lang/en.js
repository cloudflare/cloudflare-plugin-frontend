{
    ...
    "container.advanceddos.drawer.help": "Advanced protection from Distributed Denial of Service (DDoS) attacks on your website. This is an uneditable value that is 'on' in the case of Business and Enterprise zones.",
    ...
    "container.analyticCard.bandwidth.drawer.help": "Cloudflare saves you bandwidth by serving cached versions of your content from our data centers. This means that only a small number of requests actually go back to your origin server.\n\nThe more content served by our edge servers, the more bandwidth you save.",
    ...
    "container.applydefaultsettingscard.drawer.help.wordpress": "Configure Cloudflare with settings that are based on best practices learned from hundreds of thousands of WordPress sites using Cloudflare. These settings increase the security and performance of your WordPress site without impacting functionality.\n\nFor a full list of settings see our [support page](https://support.cloudflare.com/hc/en-us/articles/227342487-What-settings-are-applied-when-I-click-Apply-Default-Settings-in-Cloudflare-s-WordPress-plugin-).",
    "container.applydefaultsettingscard.drawer.help.magento": "Configure Cloudflare with settings that are based on best practices learned from existing Magento 2 stores using Cloudflare. These settings increase the security and performance of your Magento 2 store without impacting functionality.\n\nFor a full list of settings see our [support page](TODO_LINK_HERE).",
    ...
    "container.bypassCacheByCookieCard.drawer.help": "Most users see the same content on your site, but registered users may have custom content displayed. Bypass Cache by Cookie allows you to cache HTML for higher bandwidth savings for unregistered users, but bypass that cache for your registered users. This also prevents caching registered user content for unregistered users.",
    ...
    "container.pluginSpecificCacheCard.drawer.help": "When you change your site’s theme or modify content on your website, Automatic Cache Management ensures Cloudflare properly purges the cache, so that stale content is not shown to visitors.",
    ...
    "container.pluginSpecificCacheTagCard.drawer.help.magento": "Magento uses tags in order to keep track of products or other resources across your store. When you change these items, Magento purges the local cache using these tags.\n\nWith Purge Cache by Tag, Cloudflare will purge its cache based on these tags as well, ensuring visitors see content changes immediately, but still giving the performance and cost benefits of caching this content.",
